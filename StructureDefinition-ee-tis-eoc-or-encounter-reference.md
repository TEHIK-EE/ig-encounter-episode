...
| Draft as of 2026-05-15 | *Computable Name*:ExtensionEETISEoCorEncounterReference |

Extension for the need of referencing episode of care or encounter
...
* Use this Extension: [EE TIS Encounter](StructureDefinition-ee-tis-encounter.md) and [EE TIS Episode of Care](StructureDefinition-ee-tis-episode-of-care.md)
* Examples for this Extension: [EpisodeOfCare/episodeofcare1](EpisodeOfCare-episodeofcare1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ee.fhir.encounterepisode|current/StructureDefinition/ee-tis-eoc-or-encounter-reference)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fhir.ee/encounter-episode/StructureDefinition/ee-tis-encounter",
