...
```json
{
  ...
  "id" : "ee.fhir.encounterepisode",
  "url" : "https://fhir.ee/encounter-episode/ImplementationGuide/ee.fhir.encounterepisode",
  "version" : "0.1.0",
  ...
  "packageId" : "ee.fhir.encounterepisode",
  "license" : "MIT",
  "fhirVersion" : ["5.0.0"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/ee-tis-summary"
      },
      "name" : "Any free form text needed",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/ee-tis-encounter-stationary"
      },
      "name" : "EE TIS Stationary Encounter",
    ...
    },
    {
      ...
      "name" : "Example of ambulatory encounter",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "EpisodeOfCare/episodeofcare1"
      },
      "name" : "Example of episode of care",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/EETISEncounterLM"
      },
      "name" : "Tervishoiukontakt. TEST",
