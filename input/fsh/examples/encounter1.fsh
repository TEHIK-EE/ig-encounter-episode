...
* extension[0].url = "https://fhir.ee/encounter-episode/StructureDefinition/ee-tis-summary"
* extension[=].valueString = "Rutiinne ambulatoorne visiit. Patsient kaebas peavalude üle, määrati täiendav uuring."
* extension[+].url = "https://fhir.ee/base/StructureDefinition/ee-mode-of-arrival"
* extension[=].valueCoding = $arrival-mode#A "Ambulance"
* meta.versionId = "1"
