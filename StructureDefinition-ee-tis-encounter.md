...
| Draft as of 2026-04-24 | *Computable Name*:EETISEncounter |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-04-24T05:43:51+00:00",
  "publisher" : "TEHIK",
  "contact" : [{
    "name" : "TEHIK",
    "telecom" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "slicing" : {
        ...
        "description" : "When there is a need for inhouse identifier and overall identifier, different systems must be used.",
        "ordered" : false,
        "rules" : "open"
      },
    ...
    {
      "id" : "Encounter.identifier:ttoInhouseIdentifier",
      "path" : "Encounter.identifier",
      "sliceName" : "ttoInhouseIdentifier",
      "min" : 0,
      "max" : "1"
    },
    {
    ...
    },
    {
      ...
      "short" : "Use references to SPD when it is published!"
    },
    {
